...
public class EntityForgeDemon extends EntityDemon {

	
	public EntityForgeDemon(World worldIn) {
		super(worldIn);
		isImmuneToFire = true;
	...
	protected void initEntityAI() {
        ...
        this.tasks.addTask(1, new EntityForgeDemon.AICastingSpell());
        ...
        this.tasks.addTask(2, new EntityAIAvoidEntity(this, EntityForgeDemon.class, 2.0F, 0.6D, 1.0D));
        this.tasks.addTask(2, new EntityAIAvoidEntity(this, EntityPlayer.class, 4.0F, 0.6D, 1.0D));
        this.tasks.addTask(4, new EntityForgeDemon.AIForgeSpell());
        this.tasks.addTask(5, new EntityForgeDemon.AIAttackSpell());
        this.tasks.addTask(6, new EntityForgeDemon.AISummonSpell());
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityForgeDemon.class, false));
	}
	...
	public class AISummonSpell extends AIUseSpell {
        ...
        public boolean shouldExecute()
        {
            ...
            {
                int i = EntityForgeDemon.this.world.getEntitiesWithinAABB(EntityImp.class, EntityForgeDemon.this.getEntityBoundingBox().grow(16.0D)).size();
                return EntityForgeDemon.this.rand.nextInt(8) + 1 > i;
            }
        }
        ...
        public void castSpell()
        {
            for (int i = 0; i < 3; ++i)
            {
                BlockPos blockpos = (new BlockPos(EntityForgeDemon.this)).add(-2 + EntityForgeDemon.this.rand.nextInt(5), 1, -2 + EntityForgeDemon.this.rand.nextInt(5));
                EntityImp entityvex = new EntityImp(EntityForgeDemon.this.world);
                entityvex.moveToBlockPosAndAngles(blockpos, 0.0F, 0.0F);
                entityvex.onInitialSpawn(EntityForgeDemon.this.world.getDifficultyForLocation(blockpos), (IEntityLivingData)null);
                entityvex.setOwner(EntityForgeDemon.this);
                entityvex.setBoundOrigin(blockpos);
                entityvex.setLimitedLife(20 * (30 + EntityForgeDemon.this.rand.nextInt(90)));
                EntityForgeDemon.this.world.spawnEntity(entityvex);
            }
        }
	...
	public class AIForgeSpell extends AIUseSpell {
        ...
        {
            return EntityForgeDemon.this.getForgeTarget() != null && this.spellWarmup > 0;
        }
        ...
        {
            super.resetTask();
            EntityForgeDemon.this.setForgeTarget((EntityItem)null);
		...
		public boolean shouldExecute() {
            ...
            if (EntityForgeDemon.this.isSpellcasting())
            {
            	//System.out.println("isSpellcasting");
                return false;
            }
            else if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(EntityForgeDemon.this.world, EntityForgeDemon.this))
            {
            ...
            else
            {
            	...
            	List<EntityItem> list = EntityForgeDemon.this.world.<EntityItem>getEntitiesWithinAABB(EntityItem.class, EntityForgeDemon.this.getEntityBoundingBox().grow(2.0D, 2.0D, 2.0D), n -> !FurnaceRecipes.instance().getSmeltingResult(n.getItem()).equals(ItemStack.EMPTY));
                ...
                {
                    EntityForgeDemon.this.setForgeTarget(list.get(EntityForgeDemon.this.rand.nextInt(list.size())));
                    return true;
                }
            }
		}
		...
		public void castSpell() {
			// TODO Auto-generated method stub
			EntityItem entity = EntityForgeDemon.this.getForgeTarget();
			
			if (EntityForgeDemon.this.world.isRemote) return;
            ...
            if (entity != null && entity.isEntityAlive())
            {
            	//System.out.println("ENTITY ITem Forge SPELL " + entity);
                	...
                	entity.world.addWeatherEffect(new EntityDemonLightning(entity.world, EntityForgeDemon.this, entity.posX, entity.posY - 2, entity.posZ, true, false));
                	int num = entity.getItem().getCount();
                	ItemStack stac = FurnaceRecipes.instance().getSmeltingResult(entity.getItem());
                	stac.setCount(num);
                	entity.setItem(stac);
                	EntityForgeDemon.this.setHealth(EntityForgeDemon.this.getMaxHealth());
                	EntityForgeDemon.super.setSize((int)(EntityForgeDemon.this.width*1.5), (int)(EntityForgeDemon.this.height*1.5));
                	EntityForgeDemon.this.spawnExplosionParticle();
                	EntityForgeDemon.this.curePotionEffects(new ItemStack(Items.MILK_BUCKET, 1));
    ...
    protected class AIAttackSpell extends EntitySpellcasterIllager.AIUseSpell
    {
        ...
        public void castSpell()
        {
            EntityLivingBase entitylivingbase = EntityForgeDemon.this.getAttackTarget();
            double d0 = entitylivingbase.posX - EntityForgeDemon.this.posX;
            double d1 = entitylivingbase.getEntityBoundingBox().minY + (double)(entitylivingbase.height / 3.0F) - EntityForgeDemon.this.posY;
            double d2 = entitylivingbase.posZ - EntityForgeDemon.this.posZ;
            double d3 = (double)MathHelper.sqrt(d0 * d0 + d2 * d2);
            EntityLargeFireball fireball = new EntityLargeFireball(world, EntityForgeDemon.this, d0, d1 + d3 * 0.20000000298023224D, d2);
            fireball.explosionPower = 0;
            EntityForgeDemon.this.world.spawnEntity(fireball);
            /*
...
/*
    ...
    protected class AICastingSpell extends EntitySpellcasterIllager.AICastingApell
    {
        ...
        {
            if (EntityForgeDemon.this.getAttackTarget() != null)
            {
                EntityForgeDemon.this.getLookHelper().setLookPositionWithEntity(EntityForgeDemon.this.getAttackTarget(), (float)EntityForgeDemon.this.getHorizontalFaceSpeed(), (float)EntityForgeDemon.this.getVerticalFaceSpeed());
            }
            else if (EntityForgeDemon.this.getForgeTarget() != null)
            {
                EntityForgeDemon.this.getLookHelper().setLookPositionWithEntity(EntityForgeDemon.this.getForgeTarget(), (float)EntityForgeDemon.this.getHorizontalFaceSpeed(), (float)EntityForgeDemon.this.getVerticalFaceSpeed());
            }
        }
    }
