...
public class ChunkGeneratorInfernal2 implements IChunkGenerator
{
    ...
    public ChunkGeneratorInfernal2(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
            ...
            {
                return world.getBiomeProvider().getBiome(pos).getSpawnableList(creatureType);
            }
    ...
    public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos)
    {
        ...
        {
            return false;//this.woodlandMansionGenerator.isInsideStructure(pos);
        }
